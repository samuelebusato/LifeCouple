...
| **A3** | ➳ **RIMANDATA il 2026-09-15 (7), non chiusa.** L'utente ha deciso di **rendere i documenti con i segnaposto** `[indirizzo]` e `[numero di telefono]` e di sostituirli in un secondo momento. 🔴 *Quindi i due dati restano dovuti prima della revisione*, e ora sono **pubblici su `terms-of-use.html`**: `tools/genera-legale.mjs` chiude ogni esecuzione col loro conto, così la voce non dipende dalla memoria. Testo originale: 🔴 **Indirizzo e telefono del professionista (DSA)** — nel brain non esistono da nessuna parte, e dal 2026-09-15 **non esistono più nemmeno di riflesso**: la sede di Novellara era del soggetto precedente. 🔑 *Non deve essere l'abitazione* — una domiciliazione basta, e il telefono può essere dedicato | **solo tu** | **A8** |
