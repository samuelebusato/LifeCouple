...
> | | Cosa | Chi | Costo |
> |---|---|---|---|
> | 1 | **Deploy della landing** — le pagine online sono a `terms-1.2`, i file a **`terms-1.3`** | tu autorizzi, io eseguo | tre comandi |
> | 2 | **A7** — sei accordi art. 28 da accettare e archiviare | solo tu | minuti |
> | 3 | **C1** — la chiave esposta | solo tu | cinque minuti |
> | 4 | **La lingua della scheda** (§6) | solo tu | una riga |
